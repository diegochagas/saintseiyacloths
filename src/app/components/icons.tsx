  ...
  switch (name) {
    ...
    case "teogonia":
      return (
        <svg
          ...
          data-testid={`icon-${name}`}
        >
          <path className={className} fill={color} d="M12 1L2 8h20L12 1z" />
          <rect className={className} fill={color} x="3" y="9" width="2" height="10.5" />
          <rect className={className} fill={color} x="7.4" y="9" width="2" height="10.5" />
          <rect className={className} fill={color} x="11" y="9" width="2" height="10.5" />
          <rect className={className} fill={color} x="14.6" y="9" width="2" height="10.5" />
          <rect className={className} fill={color} x="19" y="9" width="2" height="10.5" />
          <rect className={className} fill={color} x="1.5" y="20" width="21" height="1.6" />
          <rect className={className} fill={color} x="0.5" y="22.1" width="23" height="1.4" />
        </svg>
      );
    case "history":
      return (
    ...
    case "news":
      return (
        ...
        >
          <g>
            <path
              d="M337.34,329.642l-9.505-0.559c-1.107-8.977-4.136-15.032-4.369-15.486c-0.01-0.018-0.022-0.035-0.031-0.054
            ...
            />
            <path
              d="M251.334,104.729h-145.88c-4.142,0-7.5,3.358-7.5,7.5s3.358,7.5,7.5,7.5h145.88c4.143,0,7.5-3.358,7.5-7.5
              S255.477,104.729,251.334,104.729z"
            />
            <path
              d="M251.334,149.927h-145.88c-4.142,0-7.5,3.358-7.5,7.5c0,4.142,3.358,7.5,7.5,7.5h145.88c4.143,0,7.5-3.358,7.5-7.5
              C258.834,153.285,255.477,149.927,251.334,149.927z"
            />
            <path
              d="M251.334,195.125h-145.88c-4.142,0-7.5,3.358-7.5,7.5c0,4.142,3.358,7.5,7.5,7.5h145.88c4.143,0,7.5-3.358,7.5-7.5
              C258.834,198.483,255.477,195.125,251.334,195.125z"
            />
            <path
              d="M251.334,240.323h-145.88c-4.142,0-7.5,3.358-7.5,7.5c0,4.142,3.358,7.5,7.5,7.5h145.88c4.143,0,7.5-3.358,7.5-7.5
    ...
    case "nike":
      return (
        <Image
          className={className}
          src="/logos/athena-nike-logo.png"
          width={222}
          height={220}
    ...
    case "nike-stroke":
      return (
        <Image
          className={className}
          src="/logos/athena-nike-logo-stroke.png"
          width={222}
          height={220}
          alt="Athena Nike logo"
          data-testid={`icon-${name}`}
