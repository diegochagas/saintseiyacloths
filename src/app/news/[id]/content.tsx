            ...
            {!error && data.date ? (
              <>
                ...
                <figure className="flex flex-col items-center my-5">
                  ...
                  <figcaption>
                    <small className="font-semibold capitalize">{getClothName(t, data.saint.cloth?.name)}</small>
                  </figcaption>
                </figure>
              ...
              <Error>
                <figure className="flex flex-col items-center gap-10 p-5 md:p-10">
                  ...
                  <figcaption className="text-xs sm:text-base">{t('newsNotFound')}</figcaption>
                </figure>
              </Error>
            )}
